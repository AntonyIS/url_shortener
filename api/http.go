...
import (
	...
	js "github.com/AntonyIS/url_shortener/serializer/json"
	ms "github.com/AntonyIS/url_shortener/serializer/msgpack"
...
func (h *handler) Post(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Cause(err) == shortener.ErrInvalidRedirect {
